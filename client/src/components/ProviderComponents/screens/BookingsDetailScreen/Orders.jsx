          ...
          {bookings.map((order) => {
            ...
            return (
              <div
                ...
                className="max-md:max-w-2xl new-md:mx-auto cursor-pointer bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <div
                ...
                >
                  ...
                  <div className="flex-1 space-y-2 text-gray-700">
                    ...
                    >
                      <UpdateOrder status={status} bookingId={orderId} />
                    </div>
                  </div>
                </div>
              </div>
