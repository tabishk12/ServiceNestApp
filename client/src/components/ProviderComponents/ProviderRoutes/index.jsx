...
import LegacyBookingRedirect from "@components/screens/SingleBooking/LegacyBookingRedirect";

export const providerRoutes = [
  { index: true, element: <ProviderHomeScreen /> },
  { path: "bookings/:id", element: <BookingsDetailScreen /> },
  { path: "profile", element: <ProfilePage /> },
  { path: "notifications", element: <NotificationScreen /> },
  { path: "setting", element: <SettingsPage /> },
  { path: "bookingDetails", element: <BookingsDetailScreen /> },
  { path: "Add-address", element: <AddressPage /> },
  { path: "booking/:bookingId", element: <SingleBookingScreen /> },
  { path: "notification/:bookingId", element: <LegacyBookingRedirect /> },
