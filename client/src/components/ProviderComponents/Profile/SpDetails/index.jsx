  ...
  return (
    <div className="m-3">
      ...
      {SpDetails && SpDetails.length > 0 ? (
        ...
        <p className="text-center text-gray-500 mt-4 cursore-pointer">
          No services registered yet.
        </p>
      )}
      <div
        className={`flex justify-between md:justify-center gap-6 lg:gap-[5em] ${pathName === "/ServiceList" ? "block" : "hidden"}`}
      >
        <button
          type="button"
        ...
        <button
          type="button"
          className="mt-4 px-4 py-2 bg-purple-800 text-white rounded hover:bg-purple-900"
        >
