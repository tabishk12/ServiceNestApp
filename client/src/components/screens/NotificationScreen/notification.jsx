    ...
    <>
      <div>
        {notifications?.map((n) => (
          <div
            key={n._id}
            className={`p-4 m-2 rounded-lg ${n.isRead ? "" : "bg-blue-100"} shadow-sm`}
            onClick={() => {
              handleClick(n);
            }}
          >
            ...
            {n.isRead ? (
              <span className="text-green-500 text-sm cursore-pointer">
                Read
              </span>
            ) : (
              <span className="text-red-500 text-sm cursore-pointer">
                Unread
              </span>
            )}
            <hr className="h-[1px]" />
